...
# The following code is part of the NOMAD Lab project, which is licensed under the Apache License 2.0.
# check https://github.com/FAIRmat-NFDI/nomad-mof/blob/main/src/nomad_mof/utils.py
